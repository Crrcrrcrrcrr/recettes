const CACHE='mes-recettes-fiches-v2';
const ASSETS=['./','./index.html','./recettes_index.json','./manifest.webmanifest','./referentiels/categories.json','./referentiels/ingredients.json','./referentiels/unites.json'];
